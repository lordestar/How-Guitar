...
const CHORD_INFO = {
  ...
  Cmaj7: {
    ...
    function:
      '在C大调中是大调主七和弦，比普通C和弦多了一个B音，带来梦幻柔和的色彩，常用于Jazz和R&B。',
  ...
  Cadd9: {
    ...
    function:
      '在C大三和弦的基础上加入D音（九度音），声音比普通C和弦更丰满，是民谣和流行歌中常用的色彩和弦。',
  ...
  D: {
    ...
    function:
      '在G大调中D是Ⅴ级属和弦，有强烈的指向G的倾向。在D大调中则是主和弦。指法上常用开放D，声音明亮。',
  ...
  Dsus4: {
    ...
    keys: 'D大调（Ⅰsus4）',
    function:
      '用四度音G替代了三度音F#，制造悬空感，通常解决到D和弦。弹D和弦前先弹Dsus4是经典套路。',
  ...
  E: {
    ...
    function:
      'E大三和弦使用大量开放空弦，声音饱满。在A大调中是Ⅴ级，是摇滚和布鲁斯中最常用的和弦之一。',
  ...
  Em: {
    ...
    function:
      '最常用的开放小调和弦之一。在G大调中是Ⅵ级（关系小调），是学习和弦进行时第一个接触的小调和弦。',
  ...
  E7: {
    ...
    keys: 'A大调（Ⅴ7）、A小调（Ⅴ7）',
    function:
      'A大/小调中的Ⅴ7和弦，E7到Am/A是经典的蓝调终止式。D音的加入使它比E和弦更有推向A的张力。',
  ...
  Fmaj7: {
    ...
    function:
      '比F和弦多了一个E音（大七度），色彩由明亮变为柔和。在C大调中作为Ⅳmaj7，常用在和弦进行中替代F。',
  ...
  G: {
    ...
    function:
      '最常用的开放式大三和弦。在C大调中G是Ⅴ级，C→G是最基本的和弦进行。无数流行歌依赖G和弦。',
  ...
  G7: {
    ...
    keys: 'C大调（Ⅴ7）',
    function:
      'C大调中的Ⅴ7和弦，G7中的F音制造了强烈的解决倾向。G7→C是音乐中最基本的终止式，没有之一。',
  ...
  Am: {
    ...
    function:
      'C大调的关系小调（Ⅵ级）。Am → F → C → G是非常经典的流行歌进行。Am是吉他手学习的第一个小调和弦。',
  ...
  Am7: {
    ...
    function:
      '比Am多了一个G音（小七度），色彩更柔和。在C大调中作为Ⅵm7，是流行R&B中的常用替代和弦。',
  ...
  Bdim: {
    ...
    function:
      '在C大调中Bdim是Ⅶ级减三和弦，常用于过渡。减和弦由小三度叠置，音色紧张，通常快速经过后解决到C。',
  ...
  B7: {
    ...
    keys: 'E大调（Ⅴ7）、E小调（Ⅴ7）',
    function:
      'E大/小调的Ⅴ7和弦，B7到Em是经典终止。B7常出现在西班牙风格的吉他曲中，用横按或开放指法。',
  ...
  'F#m': {
    ...
    function:
      '在A大调中是Ⅵ级，和A构成关系大小调。F#m是横按和弦，常在Key of D和Key of A的歌曲中出现。',
  ...
  TYPE_dim: {
    ...
    feeling: '紧张、不安、过渡',
    function:
      '由两个小三度叠置而成（根音→小三度→减五度）。音色极度紧张，常用于过渡和连接和弦，通常快速解决到目标和弦。',
  ...
  TYPE_aug: {
    ...
    feeling: '悬空、梦幻、不协和',
    function:
      '由两个大三度叠置而成（根音→大三度→增五度）。增三和弦没有明确的方向感，常用于制造梦幻或悬空氛围。',
  ...
  TYPE_sus2: {
    ...
    feeling: '空旷、纯净、无色彩',
    function:
      '用大二度音替代三度音，去掉了大小调特征，声音空旷纯净。常用于前奏和过渡段落，制造开放感。',
  ...
  TYPE_sus4: {
    ...
    feeling: '悬空、期待解决',
    function:
      '用纯四度音替代三度音，制造强烈的悬空感。听众会期待它解决到三度音。经典套路是sus4 → 大三和弦。',
  ...
  TYPE_m7: {
    ...
    feeling: '柔和、爵士感',
    function:
      '在小七和弦基础上加入小七度，是大调251进行中Ⅱ级的标配。比小三和弦更柔和，更具现代感。',
  ...
  TYPE_maj7: {
    ...
    feeling: '梦幻、温柔、爵士感',
    function:
      '在大三和弦基础上加入大七度，比普通大三和弦多了一层梦幻色彩。是Jazz和Bossa Nova的标志性和弦。',
...
function getChordExplanation(root, type) {
  // 类型映射用
  const typeClean = type.replace('major', '');
  const chordName = root + typeClean;
  ...
  if (type === 'major' || type === '') {
    return {
      ...
      function:
        root +
        '大三和弦由根音、大三度、纯五度构成，是最基本的和弦类型。在"如何吉他"中学习它是理解其他和弦的基础。',
  ...
  if (type === 'm') {
    return {
      ...
      function:
        root +
        '小三和弦由根音、小三度、纯五度构成。和大三和弦相比，三度降低了半音，带来忧郁的色彩。',
